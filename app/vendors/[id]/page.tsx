...
import { money, rollingAverage, seedVendors, type Vendor } from "@/app/components/vendors/vendorData";
    ...
    >
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <input
          ...
          inputMode="decimal"
          style={{ padding: 8, borderRadius: 10, border: "1px solid #e5e7eb", width: 130 }}
        />
        <button
          onClick={() => {
            const n = Number(cost);
